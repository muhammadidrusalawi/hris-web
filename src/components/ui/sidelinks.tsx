...
const groupedItems = [
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Attendance", href: "attendances", roles: ["admin", "manager", "employee"] },
            { title: "Leave Management", href: "leaves", roles: ["admin", "manager", "employee"] },
    ...
    },
    {
        ...
        roles: ["admin", "manager", "employee"],
        items: [
            { title: "Profile Settings", href: "auth/profile", roles: ["admin", "manager", "employee"] },
